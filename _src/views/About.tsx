...
export default component({
  ...
  computed: {
    ...
    count2() {
      return this.$store.direct.state.counter2.count;
    },
    count3() {
      return this.$store.direct.getters.counter2.p1OrDefault;
    },
    prefecture() {
      return this.$store.direct.state.counter2.prefecture;
    }
  },
  async mounted() {
  ...
  methods: {
    increment() {
      this.$store.direct.dispatch.counter2.increment2();
    },
    increment2() {
      this.$store.direct.dispatch.counter2.increment2();
    },
    async loadCovid19() {
      await this.$store.direct.dispatch.counter2.loadCovid19();
    }
  }
});
